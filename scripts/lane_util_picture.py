...
def draw_lane_center_img(img, leftx, lefty, rightx, righty,centerx,centery):
    '''
    place the image points into numpy arrays in order to make intensity map
    \n img : source image
    \n leftx, lefty, rightx, righty : curve fitting result 
    ...
    #Center Lane
    point_np[centery, centerx,0] = 0
    point_np[centery, centerx,1] = 255
    point_np[centery, centerx,2] = 0
    return point_np
